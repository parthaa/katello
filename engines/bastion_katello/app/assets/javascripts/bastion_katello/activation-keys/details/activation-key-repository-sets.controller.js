...
angular.module('Bastion.activation-keys').controller('ActivationKeyRepositorySetsController',
    ['$scope', 'translate', 'Nutupane', 'ActivationKey','RepositorySet', 'ContentOverrideHelper', 'Notification', 'CurrentOrganization',
    function ($scope, translate,  Nutupane, ActivationKey, RepositorySet, ContentOverrideHelper, Notification, CurrentOrganization) {
