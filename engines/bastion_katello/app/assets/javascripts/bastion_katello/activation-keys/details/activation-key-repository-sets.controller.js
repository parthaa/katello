...
angular.module('Bastion.activation-keys').controller('ActivationKeyRepositorySetsController',
    ['$scope', 'translate', '$location', 'Nutupane', 'ActivationKey','RepositorySet', 'ContentOverrideHelper', 'Notification', 'CurrentOrganization',
    function ($scope, translate, $location, Nutupane, ActivationKey, RepositorySet, ContentOverrideHelper, Notification, CurrentOrganization) {
        ...
        $scope.controllerName = 'katello_product_contents';
