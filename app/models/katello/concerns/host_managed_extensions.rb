  ...
  module Concerns
    module HostManagedExtensions
      ...
      included do
        ...
        attr_accessible :content_source_id, :host_collection_ids, :description, :kickstart_repository_id, :use_install_media
      end
      ...
      def use_install_media?
        kickstart_repository.blank?
      end
    end
  end
end
