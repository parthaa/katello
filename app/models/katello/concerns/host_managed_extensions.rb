  ...
  module Concerns
    module HostManagedExtensions
      ...
      def info_with_katello
        ...
        info['parameters']['kickstart_repository'] = self.kickstart_repository.try(:label)
        info
      end
      ...
      def set_hostgroup_defaults_with_katello_attributes
        if hostgroup.present?
          assign_hostgroup_attributes(%w(content_source_id content_view_id lifecycle_environment_id kickstart_repository_id))
        end
