module Katello
  class Api::V2::OrganizationsController < ::Api::V2::OrganizationsController
    ...
    def cdn_configuration
      config_keys = [:url, :username, :password, :upstream_organization_label, :ssl_ca_credential_id, :type, :upstream_lifecycle_environment_label, :upstream_content_view_label]
