module Katello
  class Api::V2::ContentViewsController < Api::V2::ApiController
    ...
    def available_puppet_modules
      ...
      repositories = @content_view.organization.library.puppet_repositories.readable
    ...
    def find_environment
      ...
      throw_resource_not_found(name: 'kt_environment', id: params[:environment_id]) if @environment.blank?
    end
