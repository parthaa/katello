...
export const ErrataTab = () => {
  ...
  const {
    onRowSelect, isSelected, searchQuery, selectedCount,
    updateSearchQuery, clearSelections, fetchBulkIds, ...selectAll
                ...
                <Tbody isExpanded={isExpanded} key={`${id}_${createdAt}`}>
                  <Tr>
                    ...
                    <Td select={{
                        ...
                        onSelect: (event, selected) => onRowSelect(selected, errataId),
                        rowIndex,
                        variant: 'checkbox',
                        }}
                    />
