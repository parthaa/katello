...
const HostContentViewDetails = ({
  contentView, lifecycleEnvironment, contentViewVersionId, contentViewVersion,
}) => (
  <GridItem xl2={3} md={6} lg={5}>
    <Card isHoverable>
      ...
      <CardBody>
        <DescriptionList isAutoColumnWidths>
          <DescriptionListGroup>
          ...
          <DescriptionListGroup>
            ...
            <DescriptionListDescription>
              <Flex>
                <FlexItem>
                  <a href={urlBuilder(`content_views/${contentView.id}/versions/${contentViewVersionId}`, '')}>{`Version ${contentViewVersion}`}</a>
                </FlexItem>
              </Flex>
            </DescriptionListDescription>
          </DescriptionListGroup>
