...
Foreman::Plugin.register :katello do
  ...
  if Katello.with_remote_execution?
    ...
    RemoteExecutionFeature.register(:katello_module_stream_update, N_("Katello: Update Module Stream"), :description => N_("Update module stream via Katello interface"), :provided_inputs => ['module_spec', 'options'])
